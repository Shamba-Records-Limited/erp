...
class EmployeeController extends Controller
{
    ...
    public function index()
    {
        ...
        // dd($employees);
        $coop_branches = CoopBranch::where('cooperative_id', $coop)->get();
        ...
        return view('pages.cooperative.hr.employee.index', compact('employees', 'countries', 'departments', 'positions', 'types','coop_branches'));
    }
    ...
    public function store(Request $req)
    {
        $req->validate([
            ...
            'coop_branch_id' => 'required|exists:coop_branches,id',
        ]);
    ...
    {
        $coop = Auth::user()->cooperative->id;
        $employee = CoopEmployee::with(['coopBranch', 'user', 'country', 'department', 'position', 'files', 'employmentType'])->withTrashed()->findOrFail($id);
    ...
    public function edit($id)
    {
        ...
        $types = EmploymentType::where('cooperative_id', $coop)->latest()->get();
        $countries = get_countries();
        $employee = CoopEmployee::with(['coopBranch', 'user', 'country', 'department', 'position',  'files', 'employmentType'])->findOrFail($id);
        return view('pages.cooperative.hr.employee.edit', compact('employee', 'countries', 'departments', 'positions', 'types'));
    }
