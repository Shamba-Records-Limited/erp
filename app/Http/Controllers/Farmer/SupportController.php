...
class SupportController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("pages.farmer.support.index", compact('tickets'));
    }
    ...
    public function view_add_ticket()
    {
        ...
        return view("pages.farmer.support.add_ticket", compact('ticket'));
    }
    ...
    \Log::info('Ticket Data:', ['ticket' => $ticket]);
        ...
        return view("pages.farmer.support.view_ticket", compact('ticket', 'comments'));
    }
        ...
        if($countComments[0]->count == 0){
             ...
             $ticket = SystemTicket::find($ticket_id);
                ...
                if ($ticket) {
                    ...
                    return redirect()->route('farmer.support.show')->with('success', 'Ticket deleted successfully.');
                }

        }
        // toastr()->error("Ticket cannot be deleted.");

        return redirect()->route('farmer.support.show')->with('error', 'Ticket cannot be deleted.');
    }
