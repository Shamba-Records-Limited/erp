  ...
  <form @submit.prevent="submit" method="post">
    <div class="form-row" :hidden="isNext">
      ...
      <div class="form-group col-lg-3 col-md-6 col-12" :hidden="isHiddenFarmer" id="farmerB">
        ...
        <multiselect v-model="fields.farmerObj" :custom-label="customLabelFarmer" :options="farmers"
      ...
      <div class="form-group col-lg-3 col-md-6 col-12">
        ...
        <div v-if="errors && errors.due_date" class="text-danger">{{errors.due_date[0]}}
        </div>
      </div>
    </div>
    <!-- next section -->
...
export default {
  ...
  methods: {
    ...
    customLabelFarmer({first_name, other_names , farmer}) {
      return `${other_names} ${first_name} - ${farmer.member_no}`
    },
    onChange(value) {
      if (value.id == 1) {
