        ...
        <div class="d-flex justify-content-between align-items-center">
          <div class="wallet-info">
            ...
            <div class="d-flex align-items-center">
                <p class="mb-0" >Acc No: 
                    <span class="font-weight-bold text-dark" >${wallet.acc_number}</span>
                </p>
                <span class="mx-3 text-muted" >|</span>
                <p class="mb-0" >Balance: 
                    <span class="balance-info font-weight-bold text-success">KES ${balance}</span>
                </p>
            </div>
          </div>
        </div>
