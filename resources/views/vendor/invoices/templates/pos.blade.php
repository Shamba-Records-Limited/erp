    ...
    <body>
        ...
        <table class="table table-items">
            ...
            <tbody>
                ...
                @php $total_discount = $item->sale->discount ?? 0;@endphp

                @foreach($invoice->items as $item)
                @php $total_discount += $item->discount;@endphp
                @php $total_amt += $item->price_per_unit*$item->quantity;@endphp
                <tr>
                    <td class="pl-0">
                        {{ $item->title }}
                ...
                @endif
                    <tr>
                        ...
                        <td class="text-right pr-0 total-amount">
                            {{ $invoice->formatCurrency($invoice->total_amount-$total_discount) }}
                        </td>
                    </tr>
            </tbody>
        </table>
