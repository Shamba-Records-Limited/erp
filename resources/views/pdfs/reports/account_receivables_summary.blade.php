...
<html lang="en">
<head>
    <title>Account Receivables Summary</title>
...
<body>
    ...
    <table class="table mt-5">
        ...
        <tr>
            <td style="text-align:center;padding:0.1rem">
                <p style="font-size:14px;margin:0;">Account Receivables Summary</p>
            </td>
        </tr>
        <tr>
            <td style="text-align:center;padding:0.1rem">
        ...
        <tbody>
            ...
            <tr style="background:#eaeaea;">
                <td class="border-0 pl-0" width="70%">
                    <p style="font-weight:bold;font-size:12px;margin:0;padding:0 0 0 5px;text-transform:uppercase;">Account Receivables</p>
                </td>
            ...
            <tr>
                <td class="border-0" width="70%">
                    <p style="font-weight:bold;font-size:10px;margin:0;padding:0 0 0 5px;text-transform:uppercase;">Total Account Receivables</p>
                </td>
                <td class="border-0" width="30%">
