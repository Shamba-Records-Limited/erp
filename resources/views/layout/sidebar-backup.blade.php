<nav class="sidebar sidebar-offcanvas dynamic-active-class-disabled" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item {!!  active_class(['admin/manage/*']) !!} ">
            <a class="nav-link" data-toggle="collapse" href="#moduleManagement" aria-expanded="{!!  is_active_route(['admin/modules*'])  !!}" aria-controls="moduleManagement">
        ...
        <li class="nav-item {!!  active_class(['cooperative/logistics/*']) !!} ">
            <a class="nav-link" data-toggle="collapse" href="#logistics" aria-expanded="{!!  is_active_route(['cooperative/logistics/*'])  !!}" aria-controls="logistics">
                <i class="menu-icon mdi mdi-truck"></i>
                <span class="menu-title">Logistics</span>
                <i class="menu-arrow"></i>
            </a>
            <div class="collapse {{ show_class(['cooperative/logistics/*']) }}" id="logistics">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/logistics/trips*']) }}">
                        <a class="nav-link" href="{{ route('cooperative.logistics.dashboard') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/logistics/vehicle_types']) }}">
                        <a class="nav-link" href="{{ route('cooperative.logistics.vehicle_types') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/logistics/vehicles']) }}">
                        <a class="nav-link" href="{{ route('cooperative.logistics.vehicles') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/logistics/transporters*']) }}">
                        <a class="nav-link" href="{{ route('cooperative.logistics.transporters') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/logistics/weighbridges*']) }}">
                        <a class="nav-link" href="{{ route('cooperative.logistics.weighbridges') }}">
                    ...
                    @if(has_right_permission(config('enums.system_modules')['Logistics']['trip_management'], config('enums.system_permissions')['view']))
                    <li class="nav-item {{ active_class(['cooperative/logistics/trips*']) }}">
                        <a class="nav-link" href="{{ route('cooperative.logistics.trips') }}">
        ...
        <li class="nav-item {!!  active_class(['cooperative/disease*']) !!} ">
            <a class="nav-link" data-toggle="collapse" href="#diseaseManagement" aria-expanded="{!!  is_active_route(['cooperative/herd/*'])  !!}" aria-controls="diseaseManagement">
                <i class="menu-icon mdi mdi-alert-outline"></i>
                <span class="menu-title">Disease Management</span>
                <i class="menu-arrow"></i>
            </a>
            <div class="collapse {{ show_class(['cooperative/disease/*']) }}" id="diseaseManagement">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/disease/mini-dashboard']) }}">
                        <a class="nav-link" href="{{ route('cooperative.disease.mini-dashboard') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/disease/categories']) }}">
                        <a class="nav-link" href="{{ route('cooperative.disease.categories') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/disease/show']) }}">
                        <a class="nav-link" href="{{ route('cooperative.disease.show') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/disease/case*']) }}">
                        <a class="nav-link" href="{{ route('cooperative.disease.reported_cases') }}">
        ...
        <li class="nav-item {!!  active_class(['cooperative/vet*']) !!} ">
            <a class="nav-link" data-toggle="collapse" href="#vetManagement" aria-expanded="{!!  is_active_route(['cooperative/vet/*'])  !!}" aria-controls="vetManagement">
                <i class="menu-icon mdi mdi-stethoscope"></i>
                <span class="menu-title">Vet & Extension Services</span>
                <i class="menu-arrow"></i>
            </a>
            <div class="collapse {{ show_class(['cooperative/vet/*']) }}" id="vetManagement">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/vet/services/show']) }}">
                        <a class="nav-link" href="{{ route('cooperative.vet.service.show') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/vet/items/show']) }}">
                        <a class="nav-link" href="{{ route('cooperative.vet.items.show') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/vet/bookings/show']) }}">
                        <a class="nav-link" href="{{ route('cooperative.vet.bookings.show') }}">
        ...
        <li class="nav-item {!!  active_class(['cooperative/procurement/*']) !!} ">
            <a class="nav-link" data-toggle="collapse" href="#procurement" aria-expanded="{!!  is_active_route(['cooperative/procurement/*'])  !!}" aria-controls="procurement">
                <i class="menu-icon mdi mdi-clipboard-list"></i>
                <span class="menu-title">Procurement</span>
                <i class="menu-arrow"></i>
            </a>
            <div class="collapse {{ show_class(['cooperative/procurement/*']) }}" id="procurement">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/procurement/store*']) }}">
                        <a class="nav-link" href="{{ route('cooperative.manufacturing.stores') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/procurement/suppliers']) }}">
                        <a class="nav-link" href="{{ route('cooperative.suppliers') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/procurement/supplies']) }}">
                        <a class="nav-link" href="{{ route('manufacturing.supplies') }}">
        ...
        <li class="nav-item {!!  active_class(['cooperative/manufacturing/*']) !!} ">
            <a class="nav-link" data-toggle="collapse" href="#manufacturing" aria-expanded="{!!  is_active_route(['cooperative/manufacturing/*'])  !!}" aria-controls="manufacturing">
                <i class="menu-icon mdi mdi-factory"></i>
                <span class="menu-title">Manufacturing</span>
                <i class="menu-arrow"></i>
            </a>
            <div class="collapse {{ show_class(['cooperative/manufacturing/*']) }}" id="manufacturing">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/manufacturing/reports']) }}">
                        <a class="nav-link" href="{{ route('cooperative.manufacturing.reports') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/manufacturing/products']) }}">
                        <a class="nav-link" href="{{ route('cooperative.manufacturings.show') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/manufacturing/rawmaterials']) }}">
                        <a class="nav-link" href="{{ route('cooperative.manufacturings.rawmaterials') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/manufacturing/production']) }}">
                        <a class="nav-link" href="{{ route('cooperative.manufacturing.production') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/manufacturing/production/expired-stock']) }}">
                        <a class="nav-link" href="{{ route('manufacturing.production.expired-stock') }}">
        ...
        <li class="nav-item {{ active_class(['cooperative/customer*']) }}">
            <a class="nav-link" data-toggle="collapse" href="#customer_management" aria-expanded="{!!  is_active_route(['cooperative/customer*'])  !!}" aria-controls="customer_management">
                <i class="menu-icon mdi mdi-contact-mail"></i>
                <span class="menu-title">{{config('enums.system_modules')['Customer Management']['crm']}}</span>
                <i class="menu-arrow"></i>
            </a>
            <div class="collapse {{ show_class(['cooperative/customer*']) }}" id="customer_management">
                <ul class="nav flex-column sub-menu">
        ...
        <li class="nav-item {!!  active_class(['cooperative/sales/*']) !!} ">
            <a class="nav-link" data-toggle="collapse" href="#sales" aria-expanded="{!!  is_active_route(['cooperative/sales/*'])  !!}" aria-controls="sales">
            ...
            <div class="collapse {{ show_class(['cooperative/sales/*']) }}" id="sales">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/sales/void-ivoices*']) }}">
                        <a class="nav-link" href="{{ route('sales.pos.void-invoices') }}">
        ...
        <li class="nav-item {!!  active_class(['cooperative/accounting/*']) !!} ">
            <a class="nav-link" data-toggle="collapse" href="#wallet" aria-expanded="{!!  is_active_route(['cooperative/accounting/*'])  !!}" aria-controls="wallet">
                <i class="menu-icon mdi mdi mdi-calculator"></i>
                <span class="menu-title">Accounting</span>
                <i class="menu-arrow"></i>
            </a>
            <div class="collapse {{ show_class(['cooperative/accounting/*']) }}" id="wallet">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/accounting/charts_of_account']) }}">
                        <a class="nav-link" href="{{ route('cooperative.accounting.charts_of_account') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/accounting/rules']) }}">
                        <a class="nav-link" href="{{ route('cooperative.accounting.rules') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/accounting/journal_entries']) }}">
                        <a class="nav-link" href="{{ route('cooperative.accounting.journal_entries') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/accounting/property']) }}">
                        <a class="nav-link" href="{{ route('cooperative.accounting.property.index') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/accounting/budget']) }}">
                        <a class="nav-link" href="{{ route('cooperative.accounting.budget.index') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/accounting/reports*']) }}">
                        <a class="nav-link" href="{{ route('cooperative.accounting.reports') }}">
        ...
        <li class="nav-item {!!  active_class(['cooperative/financial-products/*']) !!} ">
            <a class="nav-link" data-toggle="collapse" href="#financial-products" aria-expanded="{!!  is_active_route(['cooperative/financial-products/*'])  !!}" aria-controls="financial-products">
                <i class="menu-icon mdi mdi-cogs"></i>
                <span class="menu-title">Financial Products</span>
                <i class="menu-arrow"></i>
            </a>
            <div class="collapse {{ show_class(['cooperative/financial-products/*']) }}" id="financial-products">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/financial-products/dashboard']) }}">
                        <a class="nav-link" href="{{ route('financial_products.dashboard') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/financial-products/loan-configs']) }}">
                        <a class="nav-link" href="{{ route('cooperative.loan_configs') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/financial-products/saving-types']) }}">
                        <a class="nav-link" href="{{ route('cooperative.saving_types') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/financial-products/limit-rate-config']) }}">
                        <a class="nav-link" href="{{ route('cooperative.limit-rate.config') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/financial-products/loaned-farmers']) }}">
                        <a class="nav-link" href="{{ route('cooperative.loaned-farmers') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/financial-products/farmer-savings']) }}">
                        <a class="nav-link" href="{{ route('cooperative.farmer-savings') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/financial-products/loan/defaulters']) }}">
                        <a class="nav-link" href="{{ route('cooperative.loan.defaulters') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/financial-products/loan/repayments']) }}">
                        <a class="nav-link" href="{{ route('cooperative.loan.repayments') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/financial-products/loan/interest']) }}">
                        <a class="nav-link" href="{{ route('cooperative.loan.interest') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/financial-products/group-loan-config']) }}">
                        <a class="nav-link" href="{{ route('cooperative.group.loan.config') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/financial-products/group-loan-types']) }}">
                        <a class="nav-link" href="{{ route('cooperative.group_loan_types') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/financial-products/group-loan-repayments']) }}">
                        <a class="nav-link" href="{{ route('cooperative.group.loan.repayments') }}">
        ...
        <li class="nav-item {!!  active_class(['cooperative/insurance/*']) !!} ">
            <a class="nav-link" data-toggle="collapse" href="#insurance" aria-expanded="{!!  is_active_route(['cooperative/insurance/*'])  !!}" aria-controls="insurance">
                <i class="menu-icon mdi mdi-security"></i>
                <span class="menu-title">Insurance Product</span>
                <i class="menu-arrow"></i>
            </a>
            <div class="collapse {{ show_class(['cooperative/insurance/*']) }}" id="insurance">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/insurance/benefits']) }}">
                        <a class="nav-link" href="{{ route('cooperative.insurance.benefits') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/insurance/products']) }}">
                        <a class="nav-link" href="{{ route('cooperative.insurance.products') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/insurance/config/premium-adjustments']) }}">
                        <a class="nav-link" href="{{ route('cooperative.insurance.config.premium-adjustments') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/insurance/valuations']) }}">
                        <a class="nav-link" href="{{ route('cooperative.insurance.valuations') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/insurance/subscription*']) }}">
                        <a class="nav-link" href="{{ route('cooperative.insurance.subscriptions') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/insurance/claim-limits']) }}">
                        <a class="nav-link" href="{{ route('cooperative.claim-limits') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/insurance/claims']) }}">
                        <a class="nav-link" href="{{ route('cooperative.insurance.claims') }}">
                    ...
                    <li class="nav-item {{ active_class(['cooperative/insurance/transaction-history']) }}">
                        <a class="nav-link" href="{{ route('cooperative.insurance.trxn-hisory') }}">
