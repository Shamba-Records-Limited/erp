...
<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            ...
            <div class="card shadow-sm mb-5">
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn-primary btn-sm float-right" data-toggle="collapse" data-target="#addMillerAccordion"
                        ...
                        <span class="mdi mdi-plus"></span> Add New Miller
                    </button>
            ...
            <!-- Spacing and Divider -->
            <div class="my-5 py-5 border-top"></div>
            <div class="my-5"></div>


            <!-- Registered Millers Table Section -->
...
@push('custom-scripts')
<script>
    // Dynamically update sub-counties based on selected county
    $("#county_id").change(function(e) {
        $("#sub_county_id").empty().append("<option>-- Select Sub County --</option>");
        ...
        for(let subCounty of subCounties) {
            if (subCounty.county_id == e.target.value) {
                $("#sub_county_id").append(`<option value='${subCounty.id}'>${subCounty.name}</option>`);
            }
        }
    });

    // Dynamically update miller count
