    ...
    <div class="modal-container">
        <div class="modal-card">
            ...
            <div class="modal-body">
                ...
                @if($curStep == '1')
                <form action="{{ route('admin.final-product.save-details') }}" method="POST">
                    @csrf
                ...
                <div id="addRawMaterial" class="collapse border rounded p-3">
                    <form action="{{ route('admin.final-product.save-raw-material') }}" method="post">
                        @csrf
                        <input type="hidden" name="product_id" value="{{ $draftProduct->id }}" />
                        ...
                        <tbody>
                            @foreach($rawMaterials as $rawMaterial)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('admin.final-product.delete-raw-material', $rawMaterial->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
                ...
                <div class="p-2 d-flex justify-content-between mt-4">
                    ...
                    <div class="d-flex">
                        ...
                        <a href="{{ route('admin.final-products.publish') }}" class="btn btn-primary ml-2">Publish</a>
                        <form action="{{ route('admin.final-product.discard-draft') }}" method="post" class="ml-2">
                            @csrf
                            @method("DELETE")
    ...
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-end">
            ...
            <div>
                ...
                <a class="btn btn-primary" href="{{route('admin.final-products.export', 'xlsx')}}"><span class="mdi mdi-file-excel"></span>Export Excel
                </a>
                <a class="btn btn-primary" href="{{route('admin.final-products.export', 'pdf')}}"><span class="mdi mdi-file-pdf"></span>Export Pdf
                </a>
            </div>
        </div>
    </div>
