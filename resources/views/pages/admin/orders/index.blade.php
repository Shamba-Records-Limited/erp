...
<div class="card pt-6">
    <div class="card-body">
        ...
        <div class="d-flex justify-content-end">
            <a class="btn btn-primary btn-fw btn-sm" href="{{route('admin.orders.export', 'xlsx')}}">
                <span class="mdi mdi-file-excel"></span>Export Excel
            </a>
            <a class="btn btn-primary btn-fw btn-sm ml-1" href="{{route('admin.orders.export', 'pdf')}}">
            ...
            <table class="table table-hover dt clickable">
                <thead>
                    <tr>
                        ...
                        <th>Batch No</th>
                        <th>Miller</th>
                        <th>Miller Warehouse</th>
                        <th>Cooperative</th>
                        <th>Delivery</th>
                        <th>Status</th>
                        <th>Order Created</th>
                        <th>Delivery Date</th>
                        <th>Delivery Approval Date</th>
                        <th></th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        <td>{{ $key + 1 }}</td>
                        <td><a href="{{ route('admin.orders.detail', $order->id) }}">{{ $order->batch_number }}</a></td>
                        ...
                        <td>{{ $order->delivery_approval_date}}</td>
                        <td></td>
                    </tr>
                    @endforeach
                </tbody>
