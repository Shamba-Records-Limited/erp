            ...
            <div class="col-12 col-md-8 d-flex flex-column">
                ...
                <div class="collapse @if($errors->count() > 0) show @endif" id="addPricingAccordion">
                    <div class="card shadow-lg mb-4">
                        <div class="card-body">
                            <form action="{{ route('admin.products.store_product_pricing') }}" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                      ...
                                      <!-- Buying Vat -->
                                      <div class="form-group col-lg-6">
                                        <label for="buying_vat">Buying Vat</label>
                                        <input type="number" name="buying_vat"
                                            class="form-control {{ $errors->has('buying_vat') ? ' is-invalid' : '' }}"
                                            id="buying_vat" placeholder="Buying Vat"
                                            value="{{ old('buying_vat')}}" required>
                                        @if ($errors->has('buying_vat'))
                                        <span class="help-block text-danger">
                                            <strong>{{ $errors->first('buying_vat') }}</strong>
                                        </span>
                                        @endif
                                    </div>
                                     <!-- Selling Vat-->
                                     <div class="form-group col-lg-6">
                                        <label for="selling_vat">Selling Vat</label>
                                        <input type="number" name="selling_vat"
                                            class="form-control {{ $errors->has('selling_vat') ? ' is-invalid' : '' }}"
                                            id="selling_vat" placeholder="Selling Vat"
                                            value="{{ old('selling_vat')}}" required>
                                        @if ($errors->has('selling_vat'))
                                        <span class="help-block text-danger">
                                            <strong>{{ $errors->first('selling_vat') }}</strong>
                                        </span>
                                        @endif
                                    </div>
