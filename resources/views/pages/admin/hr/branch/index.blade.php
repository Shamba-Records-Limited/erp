                    ...
                    <table class="table table-hover dt">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{++$key }}</td>
                                <td>
                                    <a href="{{ route('hrad.branches.collections', $prod->id) }}">{{ $prod->name }}</a> <!-- Updated to make branch name clickable -->
                                </td>                                 <td>{{$prod->code }}</td>
                                <td>{{$prod->location }}</td>
                                <td>
                                    ...
                                    <div class="btn-group dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="text-info dropdown-item" href="{{ route('hrad.branches.detail', $prod->id) }}">
                                            ...
                                            @METHOD('DELETE')
                                           <!-- <a onclick="return confirm('Sure to Delete?')" href="/admin/hr/branches/delete/{{ $prod->id }}" class="text-danger dropdown-item">
