    ...
    <div class="card-body">
        ...
        <div class="d-flex justify-content-between">
            <div class="d-flex align-items-center">
                ...
                <div class="ml-2">
                    <select hx-get="{{route($acc_type.'.wallet-management.account-receivables.table')}}"
            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    <input hx-get="{{route($acc_type.'.wallet-management.account-receivables.table')}}"
        ...
        <div id="tableContent" hx-get="{{route($acc_type.'.wallet-management.account-receivables.table')}}"
