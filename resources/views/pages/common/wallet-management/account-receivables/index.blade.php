...
<div class="card">
    <div class="card-body">
        ...
        <div id="filter-display" class="d-flex filter-display align-items-start flex-wrap p-2">
            <input hx-get="{{route($acc_type.'.wallet-management.account-receivables.table')}}" hx-trigger="change" hx-target="#tableContent" hx-include=".table-control" hx-swap="innerHTML" name="filter" type="hidden" class="table-control" id="filter" value="" />
        ...
        <div class="d-flex justify-content-between">
            <div class="d-flex align-items-center">
                ...
                <div class="ml-2">
                    <select hx-get="{{route($acc_type.'.wallet-management.account-receivables.table')}}" hx-trigger="change" hx-target="#tableContent" hx-include=".table-control:not(#page)" hx-swap="innerHTML" class="form-control table-control" id="show-per-page" name="limit">
            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    <input hx-get="{{route($acc_type.'.wallet-management.account-receivables.table')}}" hx-trigger="keyup changed delay:500ms" hx-target="#tableContent" hx-include=".table-control:not(#page)" hx-swap="innerHTML" name="search" type="search" class="form-control table-control mb-2" placeholder="Search" aria-label="Search">
                </div>
            </div>
        </div>

        <div id="tableContent" hx-get="{{route($acc_type.'.wallet-management.account-receivables.table')}}" hx-trigger="load" hx-swap="innerHTML">
