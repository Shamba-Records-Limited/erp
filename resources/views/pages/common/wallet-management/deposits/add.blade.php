    ...
    <div class="card-body">
        ...
        <form action="{{route($acc_type.'.wallet-management.deposit')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="source_of_funds" id="source_of_funds" placeholder="Enter Source of Funds" value="{{old('source_of_funds', '')}}">
                <p>e.g. Bank, ATM, Cheque, etc.</p>
                @if($errors->has('source_of_funds'))
                <span class="help-block text-danger">
                    <span>{{ $errors->first('source_of_funds') }}</span>
                </span>
                @endif
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <span class="help-block text-danger">
                    <span>{{ $errors->first('deposit_slip') }}</span>
                </span>
                @endif
            </div>
