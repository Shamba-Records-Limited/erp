            ...
            <div class="d-flex">
                ...
                <div class="dropdown ml-2">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" id="makePayment" href="{{route($acc_type.'.wallet-management.view-make-payment')}}">Make Payment</a>
                    </div>
                </div>
                <a class="btn btn-primary ml-2" id="addOperationalExpense" href="{{route($acc_type.'.wallet-management.operational-expenses.add')}}">Add Operational Expense</a>
