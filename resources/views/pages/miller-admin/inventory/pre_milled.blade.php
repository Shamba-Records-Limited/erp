...
<div class="card">
    <div class="card-body">
        ...
        <div class="d-flex justify-content-end mb-3">
            <a class="btn btn-primary btn-fw btn-sm" href="{{ route('miller-admin.pre-milled-inventory.export', 'xlsx') }}">
                <span class="mdi mdi-file-excel"></span> Export Excel
            </a>
            <a class="btn btn-primary btn-fw btn-sm ml-1" href="{{ route('miller-admin.pre-milled-inventory.export', 'pdf') }}">
