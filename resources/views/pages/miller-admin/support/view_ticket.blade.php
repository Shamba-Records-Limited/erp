...
<div class="card">
    <div class="card-body">
        ...
        <div>
            <a href="{{route('miller-admin.support.confirm-ticket-resolved', $ticket->number)}}" class="btn btn-primary">Confirm Resolved</a>
        </div>
        @endif
        ...
        @endif
        <hr />
        <form action="{{route('miller-admin.support.add-ticket-comment')}}" method="POST">
            @csrf
