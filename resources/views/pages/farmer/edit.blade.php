...
@section('content')
    ...
    @if(has_right_permission(config('enums.system_modules')['Farmer CRM']['farmers'], config('enums.system_permissions')['edit']))
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <div>
                            <form action="{{ route('cooperative.farmer.profile.update', $farmer->user->id) }}"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <input type="text" name="f_name"
                                               ...
                                               value="{{ $farmer->user->first_name}}" required>
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <input type="text" name="u_name"
                                               ...
                                               value="{{ $farmer->user->username }}" required>
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <input type="text" name="phone_no"
                                               ...
                                               value="{{$farmer->phone_no}}" required>
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <input type="text" name="bank_account"
                                               ...
                                               value="{{ $farmer->bank_account }}" required>
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <input type="text" name="member_no"
                                               ...
                                               value="{{ $farmer->member_no}}" required>
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <select name="customer_type" id="customer_type"
                                            ...
                                            @foreach(config('enums.farmer_customer_types') as $key => $type)
                                                <option value="{{$key}}"
                                                        {{ $key == $farmer->customer_type ? 'selected' : '' }}>
                                                    {{$type}}
                                                </option>
                                            @endforeach
