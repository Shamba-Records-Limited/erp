        ...
        <div class="card">
            <div class="card-body">
                <button type="button" class="btn btn-primary btn-fw btn-sm float-right" data-toggle="collapse"
                    data-target="#addFarmerAccordion" aria-expanded="@if ($errors->count() > 0) true @else false @endif"
                ...
                <div class="collapse @if ($errors->count() > 0) show @endif " id="addFarmerAccordion">
                    <form action="{{ route('cooperative.farmer.add') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            <div class="form-group col-12">
                                <h4 class="mb-3">Farmer Details</h>
                            </div>
                            ...
                            <div class="form-group col-lg-3 col-md-6 col-12">
                                ...
                                <input type="text" name="county"
                                    ...
                                    placeholder="Nairobi" value="{{ old('county')}}" required>
                            ...
                            <div class="form-group col-lg-3 col-md-6 col-12">
                                ...
                                <input type="text" name="bank_account"
                                    ...
                                    id="bank_account" placeholder="235965..." value="{{ old('bank_account')}}" required>
                            ...
                            <div class="form-group col-lg-3 col-md-6 col-12">
                                ...
                                <input type="text" name="member_no"
                                    ...
                                    id="member_no" placeholder="123" value="{{ old('member_no')}}" required>
                            ...
                            <div class="form-group col-lg-3 col-md-6 col-12">
                                ...
                                <input type="number" name="farm_size"
                                    ...
                                    id="farm_size" placeholder="10" value="{{ old('farm_size')}}" required>
...
<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <button type="button" class="btn btn-primary btn-fw btn-sm float-right" data-toggle="collapse"
                    data-target="#bulkUploadAccordion"
                ...
                <div class="collapse @if ($errors->count() > 0 || isset($uploadErrors)) show @endif "
                    ...
                    <form action="{{ route('farmer.bulk.import') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            <div class="form-group col-12">
...
<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <button type="button" class="btn btn-info btn-fw btn-sm float-right" data-toggle="collapse"
                    data-target="#filterAccordion" aria-expanded="@if ($errors->count() > 0) true @else false @endif"
                    ...
                    <form action="{{ route('cooperative.farmers.show') }}" method="get">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-lg-3 col-md-6 col-12">
                                ...
                                <input type="text" name="member_no" class="form-control" id="filter_member_no"
                                    value="{{request()->member_no}}">
                            </div>

                            <div class="form-group col-lg-3 col-md-6 col-12">
                                <label for="filter_dob">Date of Birth Range</label>
                                <input type="text" name="dob" class="form-control" id="filter_dob"
                                    value="{{request()->dob}}">
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-lg-3 col-md-3 col-3">
                                <label for=""></label>
                                <a href="{{route('cooperative.farmers.show') }}" type="submit"
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('cooperative.farmer.download','csv') }}" method="get">
                    @csrf
                    <input type="hidden" name="request_data" value="{{ json_encode(request()->all())}}" />
                    <button type="submit" class="btn btn-sm btn-info float-right text-white">
                        <i class="mdi mdi-download"></i> CSV
                    </button>
                </form>

                <form action="{{ route('cooperative.farmer.download', 'xlsx') }}" method="get">
                    @csrf
                    <input type="hidden" name="request_data" value="{{ json_encode(request()->all())}}" />
                ...
                <form action="{{ route('cooperative.farmer.download','pdf') }}" method="get">
                    @csrf
                    <input type="hidden" name="request_data" value="{{ json_encode(request()->all())}}" />
                    ...
                    <table class="table table-hover dt clickable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$farmer->gender == "M" ? "Male": ($farmer->gender == "F" ? "Female" : "Other")}}
                                </td>
                                ...
                                <td>
                                    <a class="btn btn-info btn-rounded btn-sm"
                                        href="{{ route('cooperative.farmer.edit', $farmer->id) }}">
