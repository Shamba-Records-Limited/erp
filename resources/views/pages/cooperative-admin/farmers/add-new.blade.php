            ...
            <div class="form-row">
                ...
                <div class="form-group col-lg-3 col-md-6 col-12">
                    ...
                    <input type="text" name="username"
                        ...
                        placeholder="j_doe" value="{{ old('username')}}" required>
                ...
                <div class="form-group col-lg-3 col-md-6 col-12">
                    ...
                    <select name="country_id" id="country_id"
                        ...
                        <option value="{{$country->id}}" @if($country->name == 'Kenya') selected @endif>
                            {{ $country->name }}</option>
                        @endforeach
                ...
                <div class="form-group col-lg-3 col-md-6 col-12">
                    ...
                    <input type="text" name="id_no"
                        class="form-control  {{ $errors->has('id_no') ? ' is-invalid' : '' }}" value="{{ old('id_no')}}"
                        id="id_no" placeholder="12345678">
                    @if ($errors->has('id_no'))
                    <span class="help-block text-danger">
                ...
                <div class="form-group col-lg-3 col-md-6 col-12">
                    ...
                    <input type="text" name="phone_no"
                        ...
                        placeholder="2547..." value="{{ old('phone_no')}}">
                    ...
                    <div class="input-group">
                        <div class="custom-file">
                            <input type="file" class="custom-file-input @error('profile_picture') is-invalid @enderror"
                                id="profile_picture" name="profile_picture" value="{{ old('profile_picture') }}">
