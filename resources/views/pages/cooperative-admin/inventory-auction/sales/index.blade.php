        ...
        <div class="card shadow-sm p-4 mb-5 bg-white rounded">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <div>
                        <a class="btn btn-primary btn-sm" href="{{route('cooperative-admin.inventory-auction.export', 'xlsx')}}"><span class="mdi mdi-file-excel"></span> Download Excel Sheet</a>
                        <a class="btn btn-primary btn-sm" href="{{route('cooperative-admin.inventory-auction.export', 'pdf')}}"><span class="mdi mdi-file-pdf"></span> Download PDF</a>
                    </div>
                </div>
                ...
                <div class="collapse @if($errors->count() > 0) show @endif" id="addWarehouseForm">
                    <div class="card p-4 mt-4 shadow-sm">
                        ...
                        <form action="{{ route('cooperative-admin.inventory-auction.add-sale') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-row">
