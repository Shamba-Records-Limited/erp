    ...
    <div class="modal-container">
        <div class="modal-card">
            ...
            <div class="modal-body">
                ...
                <form action="{{route('cooperative-admin.inventory-auction.invoices.save-basic-details')}}" method="POST">
                    @csrf
                ...
                <div class="collapse border rounded p-3 mt-3" id="addInvoiceItem">
                    <form action="{{route('cooperative-admin.inventory-auction.invoices.save-invoice-item')}}" method="POST">
                        @csrf
                        <input type="hidden" name="invoice_id" value="{{$draftInvoice->id}}">
                        <div class="form-row">
...
<script>
    ...
    $("#doExport").on('click', function() {
        ...
        window.location.href = `/cooperative-admin/inventory-auction/invoices/export-many/${exportType}?start_date=${startDate}&end_date=${endDate}&export_status=${exportStatus}`;
