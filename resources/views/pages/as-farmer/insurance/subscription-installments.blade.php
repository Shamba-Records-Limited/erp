    ...
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">
                        Subscription Policy No. {{ sprintf('%03d', $subscription->id) }}
                                        ...
                                        <div class="modal fade" id="payModal_{{$i->id}}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div>
                                                        <form action="{{ route('insurance.subscription.installment.pay',$i->id ) }}"
                                                              method="post">
                                                            @csrf
                                                                ...
                                                                <div class="form-row">
                                                                    <div class="form-group col-12">
                                                                        ...
                                                                        <select name="source"
                                                                            ...
                                                                            <option value="{{\App\InsuranceInstallment::SOURCE_WALLET}}">Wallet</option>
                                                                            <option value="{{\App\InsuranceInstallment::SOURCE_MPESA}}">M-PESA <small>(coming soon)</small></option>
                                                                        </select>
