                ...
                <div class="card">
                    <div class="card-body">
                        <button type="button" class="btn btn-primary btn-fw btn-sm float-right"
                                data-toggle="collapse" data-target="#addEmployeeAccordion"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <input type="text" name="user_name"
                                               ...
                                               id="user_name" placeholder="j_doe"
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <input type="text" name="area_of_residence"
                                               class="form-control  {{ $errors->has('area_of_residence') ? ' is-invalid' : '' }}"
                                               id="area_of_residence" placeholder="Karen"
                                               value="{{ old('area_of_residence')}}" required>
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <input type="text" name="bank_account_name"
                                               class="form-control {{ $errors->has('bank_account_name') ? ' is-invalid' : '' }}"
                                               id="bank_account_name" placeholder="John Doe..."
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <input type="text" name="nssf"
                                               class="form-control {{ $errors->has('nssf') ? ' is-invalid' : '' }}"
                                               id="nssf" placeholder="1234567"
                                               value="{{ old('nssf')}}">
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <input type="text" name="nhif"
                                               class="form-control {{ $errors->has('nhif') ? ' is-invalid' : '' }}"
                                               id="nhif" placeholder="1234567"
                                               value="{{ old('nhif')}}">
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <input type="text" name="employee_number"
                                               ...
                                               id="employee_number" placeholder="EM1234"
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <input type="text" name="job_group"
                                               ...
                                               id="job_group" placeholder="C1"
                                               value="{{ old('job_group')}}" required>
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <input type="text" name="basic_salary"
                                               ...
                                               id="basic_salary" placeholder="10000"
        ...
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <button type="button" class="btn btn-primary btn-fw btn-sm float-right"
                                data-toggle="collapse" data-target="#bulkUploadEmployeeAccordion"
                                aria-expanded="@if ($errors->count() > 0) true @else false @endif"
                        ...
                        <div class="collapse @if ($errors->count() > 0 || isset($uploadErrors)) show @endif "
                            ...
                            <form action="{{ route('hr.employee.bulk.import') }}" method="post"
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input type="file"
                                                       ...
                                                       value="{{ old('employees') }}">
                                                <label class="custom-file-label"
                                                       for="exampleInputFile">Employees File</label>
                        ...
                        <table class="table table-hover dt clickable">
                            ...
                            @foreach($employees as $key => $employee)
                                <tr data-href="{{ route('hr.employees.details', $employee->id) }}">
                                    <td>{{++$key }}</td>
                                    <td>
                                        <a href="{{ route('hr.employees.details', $employee->id) }}">{{ ucwords(strtolower( $employee->name))}}</a>
                                    </td>
                                    <td> {{$employee->department }} </td>
                                    <td> {{$employee->country }} <span
                                                class="mr-2 table-flag"> <img
                                                    src="{{ asset(get_country_flag($employee->iso)) }}"/></span>
                                    </td>
                                    ...
                                    <td><a class="btn btn-sm btn-info btn-rounded"
                                           href="{{ route('hr.employees.salary', $employee->id) }}">Salary</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
