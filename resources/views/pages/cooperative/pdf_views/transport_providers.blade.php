...
<table class="table table-items">
    ...
    <tbody>
        @foreach($records as $key => $transporter)
            <tr>
                <td class="text-left">{{ $loop->iteration }}</td>
                <td class="text-left">{{ $transporter->name }}</td>
                <td class="text-left">{{ $transporter->phone_number }}</td>
                <td class="text-left">{{ $transporter->location }}</td>
            </tr>
        @endforeach
    </tbody>
</table>
