...
<table class="table table-items">
    ...
    <tr>
        ...
        <th scope="col" class="border-0">{{ 'No. Of Products' }}</th>
    ...
    @foreach($records as $key => $item)
        <tr>
            ...
            <td class="text-left">
                {{$user->cooperative->currency}} {{ number_format($tot_disc) }}
            </td>
            <td class="text-left">
                {{$user->cooperative->currency}} {{ number_format($item->balance) }}
            </td>
            <td class="text-left">
                {{ $date->format('d M Y') }}
    ...
    <tr>
        ...
        <th colspan="6">{{ $user->cooperative->currency.' '.number_format($overall_total_balance)}}</th>
    </tr>
    </tfoot>
</table>
