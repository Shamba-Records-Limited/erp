...
<body>
    ...
    <table class="table table-items">
        <thead>
            <tr>
                <th scope="col" class="border-0">{{ 'Approved Livestock/Poultry' }}</th>
            </tr>
            <tr>
        ...
        <tbody>
            @foreach($records['first_record'] as $key => $cow)
            <tr>
                <td class="text-left">
                    {{ ++$key }}
                </td>
    ...
    <table class="table table-items">
        <thead>
            <tr>
                <th scope="col" class="border-0">{{ 'Livestock/Poultry' }}</th>
            </tr>
            <tr>
                <th scope="col" class="border-0">{{ '#' }}</th>
                <th scope="col" class="border-0">{{ 'Name' }}</th>
        ...
        <tbody>
            @foreach($records['second_record'] as $key => $cow)
            <tr>
                <td class="text-left">
                    {{ ++$key }}
                </td>
