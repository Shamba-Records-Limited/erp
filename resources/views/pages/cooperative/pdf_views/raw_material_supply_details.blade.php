    ...
    <table class="table table-items">
        <thead>
            <tr>
                ...
                <th scope="col" class="border-0">{{ 'Recorded By' }}</th>
            </tr>
        </thead>
        <tbody>
        @php
        ...
        @foreach($records as $key => $supply)
            ...
            <tr>
                ...
                <td class="text-left">
                    {{\Carbon\Carbon::parse($supply->supply_date)->format('d-m-Y')}}
                </td>
                <td class="text-left">
                    {{$currency.' '.number_format($supply->amount)}}
                </td>
                <td class="text-left">
                    {{$currency.' '.number_format($supply->balance)}}
                </td>
                <td class="text-left">
                    {{number_format($supply->quantity,2)}}
                </td>
                <td class="text-left">
                    {{$currency.' '.number_format($supply->quantity * $supply->amount)}}
                </td>
                <td class="text-left">
