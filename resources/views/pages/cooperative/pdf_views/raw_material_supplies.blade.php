    ...
    <table class="table table-items">
        <thead>
            <tr>
                ...
                <th scope="col" class="border-0">{{ 'Supply Count' }}</th>
            </tr>
        </thead>
        <tbody>
        ...
        @foreach($records as $key => $supply)
            ...
            <tr>
                ...
                <td class="text-left">
                    {{number_format($supply->quantity).' '.$supply->units}}
                </td>
                <td class="text-left">
                    {{number_format($supply->total_count)}}
                </td>
            </tr>
            @endforeach
        </tbody>
        ...
        <tr>
            ...
            <th colspan="1">{{$total_quantity}}</th>
            <th colspan="1">{{$supply_count}}</th>
        </tr>
        </tfoot>
    </table>
