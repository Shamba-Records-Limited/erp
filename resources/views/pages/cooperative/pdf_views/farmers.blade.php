...
<table class="table table-items">
    <thead>
    <tr>
       Î<th scope="col" class="border-0">{{ '#' }}</th>
       Î<th scope="col" class="border-0">{{ 'Name' }}</th>
        <th scope="col" class="text-left border-0">{{ 'EMail' }}</th>
        <th scope="col" class="text-left border-0">{{ 'Phone' }}</th>
        <th scope="col" class="border-0">{{ 'Member No.' }}</th>
        <th scope="col" class="border-0">{{ 'ID No.' }}</th>
        ...
        <th scope="col" class="border-0">{{ 'Farmer Type' }}</th>
        <th scope="col" class="border-0">{{ 'Farm size (acres)' }}</th>
    </tr>
    </thead>
    <tbody>
    @foreach($records as $key => $farmer)
        <tr>
            ...
            <td class="text-left">
                {{ $farmer->gender == "M" ? "Male": ($farmer->gender == "F" ? "Female" : "Other") }}
            </td>
            <td class="text-left">
                {{ $farmer->age }}
            </td>
