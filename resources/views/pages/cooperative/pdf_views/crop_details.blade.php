    ...
    <table class="table table-items">
        <thead>
            <tr>
                ...
                <th scope="col" class="border-0">{{ 'Variety' }}</th>
                <th scope="col" class="border-0">{{ 'Farm Unit' }}</th>
                <th scope="col" class="border-0">{{ 'Recommended Areas' }}</th>
                <th scope="col" class="border-0">{{ 'Description.' }}</th>
            </tr>
        </thead>
        <tbody>
            @foreach($records as $key => $crop)
            <tr>
                <td class="text-left">
                    {{ ++$key }}
                </td>
