...
<body>
    ...
    <table class="table table-items">
        ...
        <tbody>
            @foreach($records as $key => $auditLog)
            <tr>
                <td class="text-left">
                    {{ ++$key }}
                </td>
                <td class="text-left">
                    {{ucwords(strtolower($auditLog->user->first_name.' '.$auditLog->user->other_names)) }}
                </td>
                <td class="text-left">
                    {{ $auditLog->activity }}
                </td>
                <td class="text-left">
                    {{ \Carbon\Carbon::parse($auditLog->created_at)->format('Y-m-d') }}
                </td>
            </tr>
            @endforeach
        </tbody>
