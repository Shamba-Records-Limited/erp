    ...
    <table class="table table-items">
        <thead>
            <tr>
                ...
                <th scope="col" class="border-0">{{ 'Reference Number' }}</th>
                <th scope="col" class="border-0">{{ 'Ledger' }}</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-left">
                    {{ ucwords($trans->ledger_type) }} {{ $trans->account_type}}
                </td>
                <td class="text-left">
                    {{ $trans->credit ? $currency .' '.number_format($trans->credit, 2, '.', ',') : '-'  }}
                </td>
                <td class="text-left">
                    {{ $trans->debit ? $currency .' '.number_format($trans->debit, 2, '.', ',') : '-'  }}
                </td>
                <td class="text-left">
        ...
        <tr>
            ...
            <th colspan="1">{{ $currency.' '.number_format($totalCredit) }}</th>
            <th colspan="3">{{ $currency.' '.number_format($totalDebit) }}</th>
        </tr>
        </tfoot>
    </table>
