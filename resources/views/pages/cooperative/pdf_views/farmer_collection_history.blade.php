...
<table class="table table-items">
    ...
    <tr>
        ...
        <th scope="col" class="border-0">{{ 'Date Collected' }}</th>
        <th scope="col" class="border-0">{{ 'Agent' }}</th>
        <th scope="col" class="border-0">{{ 'Comments' }}</th>
        <th scope="col" class="border-0">{{ 'Collection No.' }}</th>
    ...
    <tr>
        ...
        <th colspan="7">{{ number_format($total_collected, 2, '.',',')}}</th>
        <th colspan="1">{{ number_format($total_available, 2, '.',',')}}</th>
    </tr>
    </tfoot>
</table>
</body>
