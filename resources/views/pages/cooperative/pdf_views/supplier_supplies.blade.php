...
<body>
    ...
    <table class="table table-items">
        ...
        <tbody>
        @php $total_amount = 0; $total_quantity = 0; $currency = Auth::user()->cooperative->currency;@endphp
        ...
        <tr>
            ...
            <th colspan="1">{{$currency.' '.number_format($total_amount)}}</th>
            <th colspan="5">{{number_format($total_quantity)}}</th>
        </tr>
        </tfoot>
    </table>
