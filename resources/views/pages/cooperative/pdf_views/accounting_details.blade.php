    ...
    <table class="table table-items">
        <thead>
            <tr>
                ...
                <th scope="col" class="border-0">{{ 'Account Type' }}</th>
                <th scope="col" class="border-0">{{ 'Parent Ledger' }}</th>
                <th scope="col" class="border-0">{{ 'Ledger Code' }}</th>
            </tr>
        </thead>
        <tbody>
            @foreach($records as $key => $ledger)
            <tr>
                <td class="text-left">
                    {{ ++$key }}
                </td>
