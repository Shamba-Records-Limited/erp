    ...
    <table class="table table-items">
        <thead>
            <tr>
                ...
                <th scope="col" class="border-0">{{ 'Basic Pay' }}</th>
                <th scope="col" class="border-0">{{ 'Taxable Income' }}</th>
                <th scope="col" class="border-0">{{ 'P.A.Y.E' }}</th>
                <th scope="col" class="border-0">{{ 'Net Pay' }}</th>
        ...
        @endphp
            @foreach($records as $key => $payroll)
                @php
            ...
            <tr>
                ...
                <td class="text-left">
                    {{$currency}} {{ number_format($payroll->basic_pay,2) }}
                </td>
                <td class="text-left">
                    {{$currency}} {{ number_format($payroll->taxable_income,2) }}
                </td>
                <td class="text-left">
                    {{$currency}} {{ number_format($payroll->paye,2) }}
                </td>
                <td class="text-left">
                    {{$currency}} {{ number_format($payroll->net_pay,2) }}
                </td>
            </tr>
            @endforeach
        </tbody>
