    ...
    <table class="table table-items">
        <thead>
            <tr>
                ...
                <th scope="col" class="border-0">{{ 'Estimate Cost' }}</th>
                <th scope="col" class="border-0">{{ 'Unit' }}</th>
            </tr>
        </thead>
        <tbody>
        @php $currency  = Auth::user()->cooperative->currency; $total_estimate_cost = 0; @endphp

            @foreach($records as $key => $material)
            ...
            <tr>
                ...
                <td class="text-left">
                    {{$currency}} {{ number_format($material->estimated_cost,2,'.',',') }}
                </td>
                <td class="text-left">
                    {{$material->unit->name }}
                </td>
        ...
        <tfoot>
            <tr>
                ...
                <th colspan="2">{{ number_format($total_estimate_cost) }}</th>
            </tr>
        </tfoot>
    </table>
