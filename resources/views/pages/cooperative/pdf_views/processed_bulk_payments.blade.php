...
<table class="table table-items">
    ...
    <tr>
        ...
        <th scope="col" class="border-0">{{ 'Batch' }}</th>
        <th scope="col" class="border-0">{{ 'Initiated By' }}</th>
        <th scope="col" class="border-0">{{ 'Payment Mode' }}</th>
        <th scope="col" class="border-0">{{ 'Amount' }}</th>
        <th scope="col" class="border-0">{{ 'Date' }}</th>
        <th scope="col" class="border-0">{{ 'Date Completed' }}</th>
    ...
    <tr>
        ...
        <th colspan="4">{{ number_format($total_payment, 2) }}</th>
    </tr>
    </tfoot>
</table>
