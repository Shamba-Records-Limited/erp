    ...
    <table class="table table-items">
        <thead>
            <tr>
                ...
                <th scope="col" class="border-0">{{ 'Dependant' }}</th>
                <th scope="col" class="border-0">{{ 'Amount' }}</th>
                <th scope="col" class="border-0">{{ 'Remaining Limit' }}</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-left">
                    {{$currency.' '.number_format($c->amount) }}
                </td>
                <td class="text-left">
                    {{$currency.' '.number_format($c->subscription->current_limit) }}
                </td>
                <td class="text-left">
        ...
        <tfoot>
            <tr>
                <th scope="col" class="border-0" colspan="4"> Total</th>
                <th scope="col" class="border-0" colspan="5"> {{ $currency.' '.number_format($total_amount)}}</th>
            </tr>
        </tfoot>
    </table>
