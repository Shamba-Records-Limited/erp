...
<table class="table table-items">
    ...
    <tr>
        ...
        <th scope="col" class="border-0">{{ 'Acc No' }}</th>
        <th scope="col" class="border-0">{{ 'Bank' }}</th>
        <th scope="col" class="border-0">{{ 'Collection Worth' }}</th>
        <th scope="col" class="border-0">{{ 'Pending Payments' }}</th>
    </tr>
    </thead>
    <tbody>
    @foreach($records as $key => $item)
        ...
        <tr>
            ...
            <td class="text-left">
                {{$currency.' '.number_format($item->collection_worth,2)}}
            </td>
            <td class="text-left">
                {{$currency.' '.number_format($item->pending_payments,2)}}
            </td>
        </tr>
    @endforeach
    </tbody>
    ...
    <tr>
        ...
        <th colspan="1">{{ $currency.' '.number_format($total_pending_payments,2)  }}</th>
    </tr>
    </tfoot>
</table>
