...
<table class="table table-items">
    ...
    <tr>
        ...
        <th scope="col" class="border-0">{{ 'Collection ID' }}</th>
    ...
    @foreach($records as $key => $item)
        ...
        <tr>
            ...
            <td class="text-left">
                {{ number_format($item->quantity, 2)}} {{$item->product->unit->name }}
            </td>
            <td class="text-left">
                {{ number_format($item->available_quantity) }} {{$item->product->unit->name }}
            </td>
            <td class="text-left">
    ...
    <tr>
        ...
        <th colspan="3">{{ number_format($total_available_quality,2) }}</th>
    </tr>
    </tfoot>
</table>
