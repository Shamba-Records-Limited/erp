    ...
    <tr>
        <td class="border-0 pl-0" width="70%">
            <h4 class="text-uppercase">
                <strong>{{ Auth::user()->cooperative->name }} {{ "Profit and Loss" }}</strong>
            </h4>
        </td>
...
<table class="table table-items">
    ...
    <tr>
        ...
        <th scope="col" class="text-left border-0">{{ 'Income' }}</th>
        <th scope="col" class="text-left border-0">{{ 'Expense' }}</th>
    ...
    {{-- Summary --}}
    <tr>
        <th class="text-left mt-3" colspan="">{{ 'Balance B/F' }}</th>
