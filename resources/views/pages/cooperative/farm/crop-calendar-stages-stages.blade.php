...
@section('content')
    ...
    @php
        $theStage = $cropCalendarStages[0]->crop;
    @endphp
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="collapse @if ($errors->count() > 0) show @endif " id="addCropCalendarStage">
                            ...
                            <form action="{{ route('cooperative.farm.crop-calendar-stages.stages.add', [\App\CropCalendarStage::TYPE_CROP,$cropCalendarStages[0]->crop_id ]) }}"
                                  method="post">
                                @csrf
                                <div class="form-row">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-12">
                                            <button type="submit" class="btn btn-primary btn-fw btn-block">Update Stages
                                            </button>
                                        </div>
                                    </div>
                                </div>
